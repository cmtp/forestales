...
<div id="servicios">
	<div class="container">
    			<?php if ($page['preface1']  ): ?>
				<div id="region-preface1" class="clearfix">
					<?php print render($page['preface1']); ?>

				</div> <!-- /#footer-columns -->
				<?php endif; ?>
				<?php if ($page['preface2']  ): ?>
				<div id="region-preface2" class="clearfix">
					<?php print render($page['preface2']); ?>

				</div> <!-- /#footer-columns -->
				<?php endif; ?><?php if ($page['preface3'] ): ?>
				<div id="region-preface3" class="clearfix">
					<?php print render($page['preface3']); ?>
				</div> <!-- /#footer-columns -->
				<?php endif; ?>
...
<div id="fotos">
    <div class="container">
    	            ...
    	            <!-- region: Portafolio-->
          <?php if ($portafolio = render($page['portafolio'])): ?>
            <div id="portafolio" class="portafolio">
              <?php print $portafolio; ?>
            </div>
          <?php endif; ?>
  </div>
</div>
...
<div class="container">
          <!-- region: Clientes -->
          <?php if ($cliente = render($page['cliente'])): ?>
